...
const ClientJS = class {
  ...
  getCanvasPrint() {
    ...
    let canvas = document.createElement("canvas"); // define a context let that will be used for browsers with canvas support

    let ctx; // try/catch for older browsers that don't support the canvas element
